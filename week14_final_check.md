...
| 역할 | 함수 | 설명 |
|---|---|---|
| 조건 추출 | extract_conditions | 입력 텍스트에서 조건을 추출한다 |
...
## 발표 때 보여줄 순서
1. sample_input.txt 보여주기
2. python3 my_agent.py 실행
3. output.md 표 보여주기
4. output_user_guide.md 안내문 보여주기
5. review_report.md 검토 결과 보여주기
6. streamlit run streamlit_app.py 실행해서 화면 보여주기
